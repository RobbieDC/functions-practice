...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    cube_volume = volume_of_cube( 2 )
    assert_equal( 8, cube_volume )
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    sphere_volume = volume_of_sphere( 2 )
    assert_equal( 33.49333333333333, sphere_volume)
  end

  #You can add your own converters
  def test_fahrenheit_to_celsius()
    celsius_temp = fahrenheit_to_celsius( 10 )
    assert_equal( -12.222222222222221, celsius_temp )
  end
